...
import { LootGeneratorSettings } from "../model/LootGeneratorSettings";
import { Loot } from "../model/Loot";

export function generateLoot(enableCurrency: boolean, currencyFrequency: number, currencyTypes: currency[], lootTable: LootGeneratorSettings): Loot {
